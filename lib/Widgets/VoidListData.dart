...
class _VoidListDataState extends State<VoidListData> {
  ...
  Future<void> javafilePrinter() async {
    ...
    printTotalAmt = "${voidListData[0]["totalamount"]}";
    ...
    for (var a = 0; a < voidListData.length; a++) {
      for (var b = 0; b < voidListData[a]["stockData"].length; b++) {
        ...
        String printerDis = "${voidListData[a]["stockData"][b]["discountPercent"]}";
        ...
        detail.add({
          "stkDesc": "${voidListData[a]["stockData"][b]["stockName"]}$printerDis",
          "totalqty": "${voidListData[a]["stockData"][b]["qty"].toInt()}",

          "standardPrice": voidListData[a]["stockData"][b]["normalPrice"].toString().substring(voidListData[a]["stockData"][b]["normalPrice"].toString().lastIndexOf("."), voidListData[a]["stockData"][b]["normalPrice"].toString().length).length > 3 ?
            "${voidListData[a]["stockData"][b]["normalPrice"].toStringAsFixed(2)}".replaceAllMapped(reg, mathFunc) :
            double.parse(voidListData[a]["stockData"][b]["normalPrice"].toString().substring(voidListData[a]["stockData"][b]["normalPrice"].toString().lastIndexOf("."), voidListData[a]["stockData"][b]["normalPrice"].toString().length)) == 0.0 ?
            "${voidListData[a]["stockData"][b]["normalPrice"].toInt()}".replaceAllMapped(reg, mathFunc) :
            "${voidListData[a]["stockData"][b]["normalPrice"]}".replaceAllMapped(reg, mathFunc),

          "sellingPrice": voidListData[a]["stockData"][b]["price"].toString().substring(voidListData[a]["stockData"][b]["price"].toString().lastIndexOf("."), voidListData[a]["stockData"][b]["price"].toString().length).length > 3 ?
      ...
      for (var b = 0; b < voidListData[a]["stockReturnData"].length; b++) {
        ...
        String printerDis = "${voidListData[a]["stockReturnData"][b]["discountPercent"]}";
        ...
        detail.add({
          "stkDesc": "${voidListData[a]["stockReturnData"][b]["stockName"]}$printerDis",
          ...
          "sellingPrice": voidListData[a]["stockReturnData"][b]["price"].toString().substring(voidListData[a]["stockReturnData"][b]["price"].toString().lastIndexOf("."), voidListData[a]["stockReturnData"][b]["price"].toString().length).length > 3 ?
  ...
  Future<void> blueThermalPrinter() async {
    ...
    String printerBrandOwnerName = '${voidListData[0]["brandOwnerName"]}';
    ...
    stockDetailList.add({
      "value" : "${space * 37}Price${space * 2}Price${space * 15}"
    });
    ...
    for (var a = 0; a < voidListData.length; a++) {
      for (var b = 0; b < voidListData[a]["stockData"].length; b++) {
        ...
        String printerSku = voidListData[a]["stockData"][b]["stockName"] + printerDis;
        String printerPrice = "${voidListData[a]["stockData"][b]["price"]}";
        ...
        String printerQty = "${voidListData[a]["stockData"][b]["qty"].toInt()}";
        String printerAmt = "${voidListData[a]["stockData"][b]["totalAmount"]}";
        ...
        if(voidListData[a]["stockData"][b]["promotionStockList"].length != 0) {
          for(var c = 0; c < voidListData[a]["stockData"][b]["promotionStockList"].length; c++) {
            String printerPromoSku = "${voidListData[a]["stockData"][b]["promotionStockList"][c]["stockName"]}";
            String printerPromoQty = "${voidListData[a]["stockData"][b]["promotionStockList"][c]["qty"].toInt()}";
      ...
      for (var b = 0; b < voidListData[a]["stockReturnData"].length; b++) {
        String printerSku = voidListData[a]["stockReturnData"][b]["stockName"];
        String printerPrice = "-${voidListData[a]["stockReturnData"][b]["price"]}";
        if(printerPrice.substring(printerPrice.lastIndexOf("."), printerPrice.length).length > 3) {
          printerPrice = double.parse(printerPrice).toStringAsFixed(2);
        } else if(double.parse(printerPrice.substring(printerPrice.lastIndexOf("."), printerPrice.length)).toString() == "0.0") {
          printerPrice = double.parse(printerPrice).toInt().toString();
        ...
        String printerQty = "-${voidListData[a]["stockReturnData"][b]["qty"].toInt()}";
        String printerAmt = "-${voidListData[a]["stockReturnData"][b]["totalAmount"]}";
        if(printerAmt.substring(printerAmt.lastIndexOf("."), printerAmt.length).length > 3) {
          printerAmt = double.parse(printerAmt).toStringAsFixed(2);
        } else if(double.parse(printerAmt.substring(printerAmt.lastIndexOf("."), printerAmt.length)).toString() == "0.0") {
          printerAmt = double.parse(printerAmt).toInt().toString();
    ...
    specialAmount = voidListData[0]["discountamount"].toInt();
    ...
    if(voidListData[0]["returnTotalAmount"].toString().substring(voidListData[0]["returnTotalAmount"].toString().lastIndexOf("."), voidListData[0]["returnTotalAmount"].toString().length).length > 3) {
      printerReturnTotalAmt = "${voidListData[0]["returnTotalAmount"].toStringAsFixed(2)}";
    }else if(double.parse(voidListData[0]["returnTotalAmount"].toString().substring(voidListData[0]["returnTotalAmount"].toString().lastIndexOf("."), voidListData[0]["returnTotalAmount"].toString().length)) == 0.0) {
      printerReturnTotalAmt = "${voidListData[0]["returnTotalAmount"].toInt()}";
    } else {
      printerReturnTotalAmt = "${voidListData[0]["returnTotalAmount"]}";
    }
